...
#
# Generated by Vivado on Tue Mar 17 09:06:21 JST 2020
...
set files [list \
 [file normalize "${origin_dir}/../prj/ad_refkit/ad_refkit.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
...
proc create_hier_cell_cam_interface { parentCell nameHier } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins cam_interface/video_aclk] [get_bd_pins motor_ctl/s_axi_aclk] [get_bd_pins preimproc/video_aclk] [get_bd_pins ps_block/clk100M]
  connect_bd_net -net rot_cnt_1 [get_bd_ports r_rot_cnt] [get_bd_pins motor_ctl/r_rot_cnt]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_ports rstn] [get_bd_pins cam_interface/rstn] [get_bd_pins motor_ctl/s_axi_aresetn] [get_bd_pins preimproc/rstn] [get_bd_pins ps_block/rstn]
...
#  -string -flagsOSRD
preplace port DDR_0 -pg 1 -lvl 5 -x 1450 -y 80 -defaultsOSRD
preplace port FIXED_IO_0 -pg 1 -lvl 5 -x 1450 -y 100 -defaultsOSRD
preplace port cam_gpio -pg 1 -lvl 5 -x 1450 -y 120 -defaultsOSRD
preplace port cam_iic -pg 1 -lvl 5 -x 1450 -y 140 -defaultsOSRD
preplace port mipi_phy_if_0 -pg 1 -lvl 0 -x 0 -y 300 -defaultsOSRD
preplace port clk200M -pg 1 -lvl 5 -x 1450 -y 160 -defaultsOSRD
preplace portBus l_p_gain -pg 1 -lvl 5 -x 1450 -y 260 -defaultsOSRD
preplace portBus l_rot_cnt -pg 1 -lvl 4 -x 1130 -y 510 -defaultsOSRD -bot
preplace portBus l_target_rot_v -pg 1 -lvl 5 -x 1450 -y 280 -defaultsOSRD
preplace portBus r_p_gain -pg 1 -lvl 5 -x 1450 -y 300 -defaultsOSRD
preplace portBus r_rot_cnt -pg 1 -lvl 4 -x 1150 -y 510 -defaultsOSRD -bot
preplace portBus r_target_rot_v -pg 1 -lvl 5 -x 1450 -y 320 -defaultsOSRD
preplace portBus rstn -pg 1 -lvl 5 -x 1450 -y 180 -defaultsOSRD
preplace inst cam_interface -pg 1 -lvl 1 -x 210 -y 330 -defaultsOSRD
preplace inst motor_ctl -pg 1 -lvl 4 -x 1260 -y 290 -defaultsOSRD
preplace inst preimproc -pg 1 -lvl 2 -x 580 -y 330 -defaultsOSRD
preplace inst ps_block -pg 1 -lvl 3 -x 900 -y 220 -defaultsOSRD
preplace netloc clk_wiz_0_clk200M 1 0 5 20 450 NJ 450 NJ 450 1060 150 1430J
preplace netloc l_rot_cnt_1 1 3 1 1090 300n
preplace netloc motor_ctl_l_p_gain 1 4 1 NJ 260
preplace netloc motor_ctl_l_target_rot 1 4 1 NJ 280
preplace netloc motor_ctl_p_gain 1 4 1 NJ 300
preplace netloc motor_ctl_target_vot 1 4 1 NJ 320
preplace netloc preimproc_s2mm_introut 1 2 1 780 230n
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 40 470 390 430 NJ 430 1070
preplace netloc rot_cnt_1 1 3 1 1100 320n
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 5 30 460 380 440 NJ 440 1080 160 1420J
preplace netloc cam_interface_m_axis_video 1 1 1 N 330
preplace netloc ps_block_M04_AXI 1 1 3 400 420 NJ 420 1020
preplace netloc ps_block_M05_AXI 1 3 1 1100 200n
preplace netloc ps_block_M03_AXI 1 1 3 400 230 770J 410 1030
preplace netloc ps_block_GPIO_0_0 1 3 2 NJ 120 NJ
preplace netloc ps_block_IIC_0_0 1 3 2 NJ 140 NJ
preplace netloc ps_block_FIXED_IO_0 1 3 2 NJ 100 NJ
preplace netloc ps_block_DDR_0 1 3 2 NJ 80 NJ
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 4 20 10 NJ 10 NJ 10 1050
preplace netloc axi_vdma_0_M_AXI_S2MM 1 2 1 760 210n
preplace netloc ps_block_M08_AXI 1 3 1 1040 260n
preplace netloc ps_block_M07_AXI 1 3 1 1050 240n
preplace netloc ps_block_M06_AXI 1 3 1 1090 220n
preplace netloc mipi_phy_if_0_1 1 0 1 N 300
preplace netloc ps_block_M00_AXI 1 0 4 40 20 NJ 20 NJ 20 1040
levelinfo -pg 1 0 210 580 900 1260 1450
pagesize -pg 1 -db -bbox -sgen -150 0 1650 660
"
}
