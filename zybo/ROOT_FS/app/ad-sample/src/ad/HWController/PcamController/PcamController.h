...
namespace ad {
    ...
    public:
         ...
         */
        const core::BirdEyeImg<uint8_t>& getRoadSurfaceImage(const ImageType& type);
    ...
    private:
        ...
        core::BirdEyeImg<uint8_t> bird_eye_img_buf_;
        std::map<ImageType, core::BirdEyeImg<uint8_t>> bird_eye_img_;
    };
}
