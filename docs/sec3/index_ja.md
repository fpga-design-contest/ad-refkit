## Linuxカーネルのビルド
サンプルデザインを動かすだけの場合、ここで示す手順はスキップして構いません。\
ここで示す手順によって得られるファイルは以下の通りです。
...
$ patch -p0 < <root path of this repository>/assets/patch/linux-xlnx-v2019.1-zybo-z7-builddeb.diff
$ git add --update
...
$ cp arch/arm/boot/uImage <root path of this repository>/zybo/BOOT_FS
$ cp arch/arm/boot/dts/zynq-zybo-z7.dtb <root path of this repository>/zybo/BOOT_FS
$ cp ../linux-*.deb <root path of this repository>/zybo/ROOT_FS/package
```
